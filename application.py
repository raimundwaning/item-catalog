...
from db_init import Base, Category, Item, User
...
@app.route('/category/<int:categories_name>/item/JSON')
def itemJSON(categories_name):
...
#todo: create a new category -> done, below
